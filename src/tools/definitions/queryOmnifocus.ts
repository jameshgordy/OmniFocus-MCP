...
export const schema = z.object({
  ...
  filters: z.object({
    ...
    untagged: z.boolean().optional().describe("true = no tags (tasks, projects)"),
    hasAttachments: z.boolean().optional().describe("Tasks only"),
    stalled: z.boolean().optional().describe("Projects: active, nothing available or deferred"),
    topLevel: z.boolean().optional().describe("Projects: not in a folder")
