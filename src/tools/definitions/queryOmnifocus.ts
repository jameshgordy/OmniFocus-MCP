...
export const schema = z.object({
  ...
  filters: z.object({
    ...
    untagged: z.boolean().optional().describe("no tags (tasks, projects)"),
    hasAttachments: z.boolean().optional().describe("tasks with attachments"),
    stalled: z.boolean().optional().describe("projects with nothing actionable"),
